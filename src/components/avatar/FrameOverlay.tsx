...
export default function FrameOverlay({ slug, reduceMotion }: Props) {
  ...
  switch (slug) {
    case "frame_basic_line":
      return (
        <svg {...common}>
          <rect x="0" y="0" width="100" height="100" rx="3.5" ry="3.5" fill="none" stroke="hsl(var(--foreground))" strokeWidth="2" opacity="0.35" />
        </svg>
      );
    ...
    case "frame_soft_blue":
      return (
        <svg {...common}>
          ...
          <rect x="0" y="0" width="100" height="100" rx="3.5" ry="3.5" fill="none" stroke={`url(#${uid})`} strokeWidth="3" opacity="0.75" />
        </svg>
      );
    ...
    case "frame_violet_pulse":
      return (
        <svg {...common}>
          <rect x="0" y="0" width="100" height="100" rx="3.5" ry="3.5" fill="none" stroke="#9B87C9" strokeWidth="2.5">
            {animate && (
    ...
    case "frame_golden_mind":
      return (
        <svg {...common}>
          ...
          <rect x="0" y="0" width="100" height="100" rx="3.5" ry="3.5" fill="none" stroke={`url(#${uid})`} strokeWidth="2.5" />
          <rect x="3" y="3" width="94" height="94" rx="3" ry="3" fill="none" stroke={`url(#${uid})`} strokeWidth="1.5" opacity="0.85" />
        </svg>
      );
