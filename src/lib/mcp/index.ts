...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Nástroje pro platformu Bezli (učebnice, třídy, úlohy). Volajte `whoami` pro ověření identity, `list_my_classes` pro seznam tříd přihlášeného uživatele a `list_my_assignments` pro jeho úlohy. Data se čtou pod RLS jako přihlášený uživatel.",
