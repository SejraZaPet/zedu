...
import TeacherBezliStart from "./pages/TeacherBezliStart";
        ...
        <AuthProvider>
          ...
          <Routes>
           ...
           <Route path="/auth" element={<Auth />} />
            ...
            <Route path="/student/predmet/:subjectId/skupina/:groupId" element={<ProtectedRoute><StudentSubjectClass /></ProtectedRoute>} />
